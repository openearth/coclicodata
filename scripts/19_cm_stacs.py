...
if __name__ == "__main__":
    ...
    COLLECTION_ID = "cm"  # name of stac collection
    COLLECTION_TITLE = "Coastal mask"
    STAC_DIR = "current"
    TEMPLATE_COLLECTION = "template"  # stac template for dataset collection
    DATASET_DESCRIPTION = (
        "Coastal mask derived from MERIT digital elevation model by Lincke et al, in"
        " press 2022."
    )

    # data configurations
    # DATASET_FILENAME = "Global_merit_coastal_mask_landwards.tif"  # source data
    DATASET_FILENAME = "sample.tif"  # sample from source data
